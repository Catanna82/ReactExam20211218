            ...
            <div id='myCarousel' className='carousel slide banner-slider animated bounceInDown' data-ride='carousel'>
                <div className='carousel-inner'>
                    <div className='item active'>
                        <img className={style['pointer-img']} src='images/back1.jpg' alt='banner' />
                    </div>
                    <div className='item'>
                        <img className={style['pointer-img']} src='images/back2.jpg' alt='banner' />
                    </div>
                    <div className='item'>
                        <img className={style['pointer-img']} src='images/back3.jpg' alt='banner' />
                    </div>
                    <div className='item'>
                        <img className={style['pointer-img']} src='images/back4.jpg' alt='banner' />
                    </div>
                    <div className='item'>
                        <img className={style['pointer-img']} src='images/back5.jpg' alt='banner' />
                    </div>
                </div>
